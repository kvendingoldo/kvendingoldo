...
- [CloudOpsKit/projects](https://github.com/CloudOpsKit/projects) -  (1 day ago)
...
- [tofuutils/pre-commit-opentofu](https://github.com/tofuutils/pre-commit-opentofu) ([v1.0.4](https://github.com/tofuutils/pre-commit-opentofu/releases/tag/v1.0.4), 2 days ago) - pre-commit git hooks to take care of OpenTofu configurations
- [hashicorp/terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ([v5.68.0](https://github.com/hashicorp/terraform-provider-aws/releases/tag/v5.68.0), 4 days ago) - The AWS Provider enables Terraform to manage AWS resources.
