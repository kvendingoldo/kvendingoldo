...
- [tofuutils/pre-commit-opentofu](https://github.com/tofuutils/pre-commit-opentofu) ([v1.0.2](https://github.com/tofuutils/pre-commit-opentofu/releases/tag/v1.0.2), 2 days ago) - pre-commit git hooks to take care of OpenTofu configurations
...
- [kvendingoldo/terraform-opensearch](https://github.com/kvendingoldo/terraform-opensearch) ([v0.3.0](https://github.com/kvendingoldo/terraform-opensearch/releases/tag/v0.3.0), 3 days ago) - Terraform module to manage OpenSearch resources.
